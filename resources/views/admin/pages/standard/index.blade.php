                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <form method="POST" action="/admin/page/{{$page->slug}}/update" enctype="multipart/form-data">
                                        ...
                                        <h4 class="card-title">Описаниe (TJ)</h4>
                                             <div class="col-12 mb-30 col-lg-12">
                                             <textarea id="elm1_tj" name="description_tj">{!!$page->description_tj!!}</textarea>
                                             </div>
                                        <hr>
                                         <h4 class="card-title">Описаниe (RU)</h4>
                                             <div class="col-12 mb-30 col-lg-12" >
                                             <textarea  id="elm1_ru" name="description_ru">{!!$page->description_ru!!}</textarea>
                                             </div>
                                        <hr>
                                        <hr>
                                         <h4 class="card-title">Описаниe (EN)</h4>
                                             <div class="col-12 mb-30 col-lg-12">
                                             <textarea id="elm1_en" name="description_en">{!!$page->description_en!!}</textarea>
                                             </div>
                                       <hr>
                                        <div class="product-upload-gallery  flex-wrap mt-5">
                                       <div><h4 class="card-title">Картинка для баннера</h4></div>
                                        <p class="card-title-desc">

                                         Картинка для баннера должно (1920х400) px.
                                        </p>
                    <div class="col-12 mb-30 col-lg-12">
