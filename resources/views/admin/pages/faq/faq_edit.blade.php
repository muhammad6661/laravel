                                ...
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active"><a   href="/admin/page/voprosy-i-otvety/faqs/{{isset($_COOKIE['pageurl']) ? $_COOKIE['pageurl'] : ''}}">Вопросы и ответы</a></li>
                                            <li class="breadcrumb-item active">{{$faq->question_tj}}</li>
                                        </ol>
                                    </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="/admin/page/voprosy-i-otvety/update-faq/{{$faq->id}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input id="productname" name="question_tj" type="text" class="form-control" value="{{$faq->question_tj}}" required>
                            </div>
                            <div class="col-12 mb-30 col-lg-12 form-group">
                                <h4 class="card-title">Ответь (TJ)</h4>
                                <textarea id="elm1_tj" name="answer_tj" >{{$faq->answer_tj}}</textarea>
                            </div>
                            <hr>
                            <div class="form-group">
                                <label for="productname">Вопрос (RU)</label>
                                <input id="productname" name="question_ru" type="text" class="form-control" value="{{$faq->question_ru}}" >
                            </div>
                            <div class="col-12 mb-30 col-lg-12 form-group">
                                <h4 class="card-title">Ответь (RU)</h4>
                                <textarea id="elm1_ru" name="answer_ru" >{{$faq->answer_ru}}</textarea>
                            </div>
                            <hr>
                            <div class="form-group">
                                <label for="productname">Вопрос (EN)</label>
                                <input id="productname" name="question_en" type="text" class="form-control"  value="{{$faq->question_en}}">
                            </div>
                            <div class="col-12 mb-30 col-lg-12 form-group">
                                <h4 class="card-title">Ответь (EN)</h4>
                                <textarea id="elm1_en" name="answer_en"  >{{$faq->answer_en}}</textarea>
                            </div>
                            <hr>
