        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="/admin/page/otchyetii-ipdo-tadzheekeestana/store-document" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="product-upload-gallery  flex-wrap mt-5" id="form_file">
                                       <div><h4 class="card-title">Файл* (RU)</h4></div>
                                        ...
                                        <div class="col-12 mb-30 col-lg-12">
                                         <input class="dropify" type="file" id="profile_pic" name="file_ru" accept=".pdf,.doc,.docx,.txt,.xls,.xlsx,.csv,.ppt,.zip">
                                   </div>
                               </div>
                                <div class="product-upload-gallery  flex-wrap mt-5" id="form_file">
                                       <div><h4 class="card-title">Файл* (TJ)</h4></div>
                                        ...
                                        <div class="col-12 mb-30 col-lg-12">
                                         <input class="dropify" type="file" id="profile_pic" name="file_tj" accept=".pdf,.doc,.docx,.txt,.xls,.xlsx,.csv,.ppt,.zip">
                                   </div>
                               </div>
                               <div class="product-upload-gallery  flex-wrap mt-5" id="form_file">
                                <div><h4 class="card-title">Файл* (EN)</h4></div>
                                 ...
                                 <div class="col-12 mb-30 col-lg-12">
                                  <input class="dropify" type="file" id="profile_pic" name="file_en" accept=".pdf,.doc,.docx,.txt,.xls,.xlsx,.csv,.ppt,.zip">
                            </div>
                        </div>
