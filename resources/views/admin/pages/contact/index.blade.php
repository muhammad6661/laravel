                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="form-group">
                                        <label for="productname">Google_lat
                                        <input id="productname" name="google_lat" type="text" class="form-control" value="{{$page->google_lat}}" required>
                                    </label>
                                </div>
                                <div class="form-group">
                                    <label for="productname">Google_long
                                        <input id="productname" name="google_long" type="text" class="form-control" value="{{$page->google_long}}" required>
                                    </label>
                                </div>
