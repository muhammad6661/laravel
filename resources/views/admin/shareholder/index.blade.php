                            ...
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right col-lg-6">
                                        <button  class="btn btn-primary waves-effect waves-light" style="float:right;cursor: pointer; "> <a style="color:cornsilk" href="/admin/organization/{{$organization->id}}/shareholder/create">Добавить</a></button>
                                        <div class="" style="margin-top:10px; float:right;padding-right:20px;">
                                            <ol class="breadcrumb m-0">
                                                <li class="breadcrumb-item"><a href="/admin/organizations">Организация</a></li>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center" style="width:50px;vertical-align: middle;">
                                            <a  data-toggle="tooltip" href="/admin/shareholder/edit/{{$item->id}}" class="editableIcons mr-3 ml-3" data-original-title="Редактировать"><i class=" fas fa-pencil-alt" style="font-size: 16px;"></i></a>
