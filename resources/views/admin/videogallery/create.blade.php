...
@section('title','Добавить виидео галерея')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0">Добавить видео галерея</h4>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="/admin/videogallery/store" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input id="productname" name="link" type="text" class="form-control" value="{{old('link')}}" required>
                            </div>
                                ...
                                <div class="product-upload-gallery  flex-wrap mt-5">
                                  ...
                                  <input class="dropify" type="file" id="profile_pic" name="image" accept="image/x-png,image/gif,image/jpeg"  >
