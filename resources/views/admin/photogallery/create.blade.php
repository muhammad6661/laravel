...
@section('title', 'Добавить Фотогалерея')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">Добавить фотогалерея</h4>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form  action="javascript:void(0)" enctype="multipart/form-data" id="form_photo">
                                 <div id="error"> </div>
                                ...
                                <div class="product-upload-gallery  flex-wrap mt-5">
                                    ...
                                    <div class="col-12 mb-30 col-lg-12">
                                        ...
                                        <input class="dropify" type="file" id="image" name="image" accept="image/*" >
                                    </div>
                                </div>
                              <hr>
                                <div class="col-12 mb-30 col-lg-12 form-group">
                                    <h4 class="card-title">Текст (RU)</h4>
                                    <textarea id="text_ru" name="text_ru"  class="form-control" rows="6"></textarea>
                                </div>
                                <div class="col-12 mb-30 col-lg-12 form-group">
                                    <h4 class="card-title">Текст (TJ)</h4>
                                    <textarea id="text_tj" name="text_tj"  class="form-control"  rows="6"></textarea>
                                </div>

                                <div class="col-12 mb-30 col-lg-12 form-group">
                                    <h4 class="card-title">Текст (EN)</h4>
                                    <textarea id="text_en" name="text_en"  class="form-control"  rows="6"></textarea>
                                </div>
                                <hr>
                                <div class="row">
                                    <div class="product-upload-gallery  flex-wrap mt-5">
                                    ...
                                    <div class="col-12 mb-30 col-lg-12">
                                        ...
                                        <input class="dropify" type="file" id="gallery" name="gallery"  accept="image/*" multiple>
                                    </div>
                                    <div class="mt-2  col-lg-3" style="margin-left:80px;">
                                        <span id="upload" class="btn btn-primary waves-effect waves-light">Загрузить</span></div>
                                </div>
                                ...
                                <div class="row" id="form_galleries" style="padding-left:25px;">
                                   ...
                                   <div class="text-center mt-4">
                                    <button id="submit_photo" class="btn btn-primary waves-effect waves-light"
